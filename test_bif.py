...
# b.compute_fixed_points_diagram(initial_points, extra_comparison_parameters=['psi_a_2', 'psi_a_5'], comparison_tol=[2.e-2, 2.e-3, 2.e-3], ICP=['C_go1'], PAR={'C_go1': 300., 2: 300. * 0.4, 3: 0.085, 4: 0.02})
